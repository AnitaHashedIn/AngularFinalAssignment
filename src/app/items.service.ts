...
export class ItemsService {
  ...
  constructor(private http:HttpClient) {
    ...
    },
    {
      ...
      "details": "Vel alias tempore molestiae deleniti dolor non. Tempore qui dignissimos exercitationem qui deserunt illum ipsum possimus eligendi. Aut cumque qui qui aperiam fugit. Ut laboriosam maxime veritatis veniam velit. Blanditiis et sit labore ad quis maiores et qui adipisci.\n \rMaxime quibusdam itaque modi. Tenetur ipsa eligendi ut sunt. Voluptatum id sint cupiditate.\n \rDolor autem sit nisi. Et ea et quas. Omnis qui sunt. Est cum quasi quia minima.",
    ...
    },
    {
      ...
      "details": "Aperiam iure ut quidem minima. Dolorem error amet mollitia occaecati cum qui aperiam. Vel sunt alias aut aut autem. Iure itaque at corporis voluptatem tenetur. Sed facere et voluptatem eum veritatis repudiandae alias rerum minus. Similique consequuntur assumenda dolores nisi autem sapiente nihil.\n \rVeritatis ut voluptatum deserunt numquam molestias et in rerum. Sit sapiente molestiae non officia illo asperiores. Non sunt quaerat et recusandae.\n \rSint magnam possimus. Rerum neque ducimus temporibus nihil. Blanditiis omnis et.",
  ...
  OnAddtocart(item: ListItem): void {
    ...
    const i: number = this.WishList.indexOf(item);
      if (i !== -1) {
        this.WishList.splice(i, 1);
        }
    const index: number = this.ListItemData.indexOf(item);
      if (index !== -1) {
  ...
  OnDeleteItemWishlist(item: ListItem): void {
    const index: number = this.WishList.indexOf(item);
      if (index !== -1) {
        this.WishList.splice(index, 1);
        }
  }
  OnWishlist(item: ListItem): void {
    this.WishList.push(item);
    const i: number = this.AddtoCartList.indexOf(item);
      if (i !== -1) {
